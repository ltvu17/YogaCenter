          ...
          <Grid container className="inf-center-detail">
            <Grid item md={6} p={2} pl={10} pr={10} className="introduction">
              ...
              <p>
                ...
                professional instructors and a safe environment, we are
                committed to providing you with a reliable and high-quality yoga
                experience. Put your trust in us and discover your potential
                with YogaFPTU
              </p>
            </Grid>
              ...
              <Grid container spacing={2}>
                <Grid item md={6}>
                  <Grid container direction="row" spacing={2}>
                    <Grid item xs={6} width="50%">
                      <Box p={2}>
                        <p style={{color:'rgb(210, 96, 141)',fontSize:'28px',fontWeight:800}}>3</p>
                        <h4 style={{marginTop: '6px',fontFamily: 'sans-serif', fontWeight: 700}}>YEAR OF EXPERIENCE</h4>
                        <p style={{marginTop: '12px',fontFamily: 'inherit',fontSize: '13px',opacity:' 0.8',lineHeight: 1.4}}>
                          We have been tirelessly working over the years to
                    ...
                    <Grid item xs={6} width="50%">
                      <Box p={2}>
                        <p style={{color:'rgb(210, 96, 141)',fontSize:'28px',fontWeight:800}}>300+</p>
                        <h4 style={{marginTop: '6px',fontFamily: 'sans-serif', fontWeight: 700}}>HAPPY CLIENTS</h4>
                        <p style={{marginTop: '12px',fontFamily: 'inherit',fontSize: '13px',opacity:' 0.8',lineHeight: 1.4}}>
                ...
                <Grid item md={6}>
                  <Grid container direction="row" spacing={2}>
                    <Grid item xs={6} width="50%">
                      <Box p={2}>
                        <p style={{color:'rgb(210, 96, 141)',fontSize:'28px',fontWeight:800}}>15</p>
                        <h4 style={{marginTop: '6px',fontFamily: 'sans-serif', fontWeight: 700}}>EXPERIENCED TRAINERS</h4>
                        <p style={{marginTop: '12px',fontFamily: 'inherit',fontSize: '13px',opacity:' 0.8',lineHeight: 1.4}}>               
                          All of our trainers possess exceptional expertise and are fully certified by reputable organizations
                        </p>
                      </Box>
                    </Grid>
                    <Grid item xs={6} width="50%">
                      <Box p={2}>
                        <p style={{color:'rgb(210, 96, 141)',fontSize:'28px',fontWeight:800}}>20</p>
                        <h4 style={{marginTop: '6px',fontFamily: 'sans-serif', fontWeight: 700}}>CLASSROOMS</h4>
                        <p style={{marginTop: '12px',fontFamily: 'inherit',fontSize: '13px',opacity:' 0.8',lineHeight: 1.4}}>
                        Spacious and Well-Equipped Classrooms for Optimal Learning Experience
                        </p>
                      </Box>
                    </Grid>
                  </Grid>
