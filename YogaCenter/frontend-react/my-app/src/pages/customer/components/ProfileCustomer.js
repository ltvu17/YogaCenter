                ...
                <Grid container>
                    <Grid xs={6} md={5} sx={{ paddingTop: '50px', paddingBottom: '50px', paddingRight: '20px', paddingLeft: '40px' }}>
                        ...
                        <CardActions className="changeProfile">
                            ...
                            <Button sx={{ border: "1px dashed #532e4d", padding: '20px' }} onClick={handlePasswordChange}>
                                Change Password
                            </Button>
                        </CardActions>
                    </Grid>
                        ...
                        {changePassword ? (
                            <div className="profileCustomer-save">
                                <div className="form-row">
                                    ...
                                    <TextChangePassword id="currentPassword" name="currentPassword" type="password" variant="outlined"/>                        
                                </div>
                                <div className="form-row">
                                    <label htmlFor="newPassword">New password</label>   
                                    <TextChangePassword id="newPassword" name="newPassword" type="password" />                              
                                </div>
                                <div className="form-row">
                                    <label htmlFor="confirmNewpassword">Confirm new password</label>                       
                                    <TextChangePassword id="confirmNewpassword" name="confirmNewpassword" type="password"/>                             
                                </div>
                                <CardActions sx={{ paddingTop: "22px",position:"relative",top:"140px" }}>
                                    <Button className="button-save"  variant="contained" onClick={handleSubmit}>Save</Button>
                                    <Button className="button-cancel"  variant="contained" onClick={() => setChangePassword(false)}>Cancel</Button>
                                </CardActions>
                            </div>
                                ...
                                {editing ? (
                                    <div className="profileCustomer-save">
                                        ...
                                        <CardActions sx={{paddingTop: "22px"}} >
                                            <Button className="button-save" onClick={handleEditProfile} variant="contained">
                                                Save
                                            </Button>
                                            <Button className="button-cancel" onClick={handleEditProfile} variant="contained">
                                                Cancel
                                            </Button>
                                        </CardActions>
                                    </div>
